...
- **`VECTOR_STORE_AUTH_ENABLED`**: Optional, default is set to True.  Set as False when running the API and Vector Store locally or the Vector Store is a side-car deployment alongside the API in Cloud Run
